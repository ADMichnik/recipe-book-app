...
export class RecipeListComponent {
  recipes: Recipe[] = [
    ...
    new Recipe (`Cauliflower pizza crust`, `I made this photo for a recipe blog post on how to make a cauliflower crust pizza`, `https://upload.wikimedia.org/wikipedia/commons/3/37/Cauliflower_pizza_crust_%2817024767906%29.jpg`)
  ];
